module Css.Global exposing
    ...
    , style, rule
    , keyframes
    , toStyleNode, toStyleNodes
    , batch
    , imports
    , a, abbr, address, area, article, aside, audio, b, base, bdi, bdo, blockquote, body, br, button, canvas, caption, cite, code, col, colgroup, data, datalist, dd, del, details, dfn, dialog, div, dl, dt, em_, embed, fieldset, figcaption, figure, footer, form, h1, head, header, hgroup, hr, html, i, iframe, img, input, ins, kbd, label, legend, li, link, main_, map, mark, mathML, menu, meta, meter, nav, noscript, object, ol, optgroup, option, output, p, param, picture, pre, progress, q_, rp, rt, ruby, s_, samp, script, section, select, slot, small, source, span, strong, sub, summary, sup, svg, table, tbody, td, template, textarea, tfoot, th, thead, time, title, tr, track, u, ul, var, video, wbr
    )
...
toStyleNodes statements =
    toStyleNodesFrom statements <| Stylesheet [] [] Dict.empty


toStyleNodesFrom : List Statement -> Stylesheet -> List ( String, Node msg )
